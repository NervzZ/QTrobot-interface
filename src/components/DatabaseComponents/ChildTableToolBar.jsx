...
import CreateChildForm from "SRC/components/DatabaseComponents/CreateChildForm";
...
ChildTableToolBar.propTypes = {
    selected: PropTypes.array.isRequired,
    setSelected: PropTypes.func.isRequired
};

export default function ChildTableToolBar(props) {
    ...
    const deleteHandler = () => {
        childViewModel.deleteChildren(selected)
            .then(() => {
                setSelected([])
            })
            .catch((error) => {
    ...
    return (
        ...
        >
            ...
            <CreateChildForm open={open} handleClose={handleClose}/>
